...
public class MenuBar extends Container implements ActionListener {
    ...
    static int rightSK;
    /**
     * This member holds the center soft key value
     */
    static int centerSK;
    /**
    ...
    protected void initMenuBar(Form parent) {
        ...
        if (softkeyCount > 1 && (commandBehavior < Display.COMMAND_BEHAVIOR_BUTTON_BAR
                || commandBehavior == Display.COMMAND_BEHAVIOR_NATIVE)) //Axthelm: 4/17/12 - Made a native 3 button softkey to support Nokia.
        {
            if (thirdSoftButton) {
    ...
    public void showMenu() {
        ...
        if (thirdSoftButton && getCommandBehavior() != Display.COMMAND_BEHAVIOR_NATIVE) //Axthelm: 4/17/12 - Made a native 3 button softkey to support Nokia. 
        {
    ...
    static boolean isCSK(int keyCode) {
        return keyCode == centerSK;
    }
    ...
    public boolean handlesKeycode(int keyCode) {
        ...
        if (keyCode == centerSK || keyCode == leftSK || (keyCode == rightSK || keyCode == rightSK2) || keyCode == backSK ||
    ...
    public void keyPressed(int keyCode) {
        ...
        if (getCommandCount() > 0) {
            if (keyCode == leftSK) {
                ...
                }else if(thirdSoftButton && commandBehavior == Display.COMMAND_BEHAVIOR_NATIVE)//Axthelm 4/17/12 - support for nokia 3rd softkey.
                {
                    if (keyCode == centerSK && main != null) {                    
                        main.pressed();
                    }
                }else {
